...
export declare class ProformasService {
    ...
    create(createProformaInput: CreateProformaInput): string;
    findAll(): any;
    findOne(CUSTNMBR: string): any;
    update(id: number, updateProformaInput: UpdateProformaInput): string;
    remove(id: number): string;
    findByCustomerRIF(CUSTNMBR: string): Prisma.PrismaPromise<({
        work_history: {
            SOPTYPE: number;
            SOPNUMBE: string;
            USRDAT01: Date;
        ...
        sales_taxes_work_history: {
            ...
            BKOUTTAX: number;
            TXABLETX: number;
            STAXAMNT: Prisma.Decimal;
            ORSLSTAX: Prisma.Decimal;
            FRTTXAMT: Prisma.Decimal;
            ORFRTTAX: Prisma.Decimal;
            MSCTXAMT: Prisma.Decimal;
            ORMSCTAX: Prisma.Decimal;
            TAXDTSLS: Prisma.Decimal;
            ORTOTSLS: Prisma.Decimal;
            TDTTXSLS: Prisma.Decimal;
            ORTXSLS: Prisma.Decimal;
            TXDTOTTX: Prisma.Decimal;
            OTTAXPON: Prisma.Decimal;
            DELETE1: number;
            CURRNIDX: number;
            TRXSORCE: string;
            TXDTLPCTAMT: Prisma.Decimal;
            DEX_ROW_ID: number;
        }[];
        khistory: {
            SOPTYPE: number;
    ...
    findBySOPNUMBE(SOPNUMBE: string): Prisma.Prisma__ProformaClient<{
        detail: {
            SOPTYPE: number;
            SOPNUMBE: string;
            LNITMSEQ: number;
