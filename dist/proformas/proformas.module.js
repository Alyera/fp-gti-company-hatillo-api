...
const proformas_resolver_1 = require("./proformas.resolver");
...
exports.ProformasModule = ProformasModule = __decorate([
    (0, common_1.Module)({
        providers: [proformas_resolver_1.ProformasResolver, proformas_service_1.ProformasService, prisma_service_1.PrismaService],
    })
], ProformasModule);
