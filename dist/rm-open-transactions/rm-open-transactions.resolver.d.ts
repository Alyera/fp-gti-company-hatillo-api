...
export declare class RmOpenTransactionsResolver {
    private readonly rmOpenTransactionsService;
    constructor(rmOpenTransactionsService: RmOpenTransactionsService);
    createRmOpenTransaction(createRmOpenTransactionInput: CreateRmOpenTransactionInput): string;
    ...
    updateRmOpenTransaction(updateRmOpenTransactionInput: UpdateRmOpenTransactionInput): string;
    removeRmOpenTransaction(id: number): string;
}
